...
int32_t C3_GrChunksNum = 479;
int32_t C3_GrChunksPos[479] = {
...
int32_t C3_AudioChunksNum = 92;
int32_t C3_AudioChunksPos[92] = {
...
void SPD_SetupCatacomb3DData() {
	...
	AudioChunksSize = C3_AudioChunksSize;
	mapData = SPD_ReadFile("GAMEMAPS.C3D", &mapDataSize);
	auData = SPD_ReadFile("AUDIO.C3D", &auDataSize);
	grData = SPD_ReadFile("EGAGRAPH.C3D", &grDataSize);
