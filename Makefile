CFLAGS=-g #-DNOMUSIC
LDFLAGS=-g -lSDL
SRCS=sp_main.c sp_graph.c sp_audio.c sp_data.c c_draw.c c_trace.c id_in.c id_sd.c id_us_1.c id_us_2.c id_vw.c opl.cpp
SRCS_C3=sp_data_c3.c c3_act1.c c3_draw.c c3_game.c c3_main.c c3_play.c c3_state.c c3_wiz.c
SRCS_C4=sp_data_c4.c c4_act1.c c4_draw.c c4_game.c c4_main.c c4_play.c c4_state.c c4_wiz.c
...
debugc4 : cata4
	cd Cata4 && gdb -ex run --args ../cata4 --nograb
