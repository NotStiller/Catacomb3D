...
void lzwDecompressFromRAM(byte *SrcPtr, byte *DstPtr, longword SrcLen);
void lzwDecompressFromFile(BufferedIO *SrcPtr, byte *DstPtr, longword SrcLen);
...
void SwapWord(unsigned int *Var);
